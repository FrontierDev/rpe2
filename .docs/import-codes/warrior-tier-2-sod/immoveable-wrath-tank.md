# Immoveable Wrath — Tank

Season of Discovery Warrior Tier 2 Draconic tank set.

Each block below is a standalone `RPE_DATASET_ENTRY_V1` import code for the Warrior dataset (`sb4b9ef3`).
    ...
    entry = {
        ...
        conditions = {
            ...
            },
            {
                ...
                invert = false,
                showOnTooltip = true,
                tooltipTextOverride = "Classes: Warrior",
                type = "class",
            },
        },
...
RPE_DATASET_ENTRY_V1
{
    ...
    entry = {
        ...
        genericModificationKey = "",
        greenSockets = 0,
        icon = "interface/icons/inv_boots_plate_04.blp",
        id = "wr2tboot",
        isTwoHanded = false,
        itemLevel = 75,
        itemSetKey = "t2_warrior_tank",
...
RPE_DATASET_ENTRY_V1
{
    ...
    entry = {
        ...
        genericModificationKey = "",
        greenSockets = 0,
        icon = "interface/icons/inv_helmet_71.blp",
        id = "wr2tface",
        isTwoHanded = false,
        itemLevel = 75,
        itemSetKey = "t2_warrior_tank",
...
RPE_DATASET_ENTRY_V1
{
    ...
    entry = {
        ...
        genericModificationKey = "",
        greenSockets = 0,
        icon = "interface/icons/inv_shoulder_34.blp",
        id = "wr2tpaul",
        isTwoHanded = false,
        itemLevel = 75,
        itemSetKey = "t2_warrior_tank",
