# Darkmantle Armor — Rogue Tank

Season of Discovery Rogue Dungeon Set 2 / Tier 0.5 tank pieces from the Battle reward line.

Each block below is a standalone `RPE_DATASET_ENTRY_V1` import code for the Rogue dataset (`iectp9f1`).

All pieces are normalized to RPE item level **60** while retaining their Season of Discovery Darkmantle Armor stats.
