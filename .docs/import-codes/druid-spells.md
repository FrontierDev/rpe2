...
RPE_DATASET_ENTRY_V1
{
    ...
    entry = {
            ...
            tooltipTemplate = true,
            tooltipTemplateData = {
                        bodyText = "Increases Threat Generated by {AURA_STAT_1}%. When the affected unit is attacked, deal {AURA_EVENT_DAMAGE_1} Nature damage to the attacker.",
                        bodyTokens = {
                                        {
                        ...
                        auraSections = {
                                        {
                                                            auraRef = "6e4d2a91:drthaur1",
                                                            datasetId = "6e4d2a91",
                                                            descriptionText = "Increases Threat Generated by {AURA_STAT_1}%. When the affected unit is attacked, deal {AURA_EVENT_DAMAGE_1} Nature damage to the attacker.",
                                                            duration = 10,
                                                            icon = "interface/icons/spell_nature_thorns.blp",
                                                            nameText = "Thorns",
                                                            powerLevel = 0,
