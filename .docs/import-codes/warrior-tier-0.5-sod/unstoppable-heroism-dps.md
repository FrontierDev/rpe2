# Battlegear of Heroism — Unstoppable

Season of Discovery Warrior Dungeon Set 2 / Tier 0.5 melee DPS pieces.

Each block below is a standalone `RPE_DATASET_ENTRY_V1` import code for the Warrior dataset (`sb4b9ef3`).

All pieces are normalized to RPE item level **60** while retaining their Season of Discovery Battlegear of Heroism stats.
...
RPE_DATASET_ENTRY_V1
{
    ...
    entry = {
        ...
        isTwoHanded = false,
        itemLevel = 60,
        itemSetKey = "t05_warrior_heroism",
        itemType = "armor",
        maxDamagePerTurn = 0,
