...
- RPE currently has **Block Chance** and **Defense Rating**, but no **Shield Block Value** stat. Protection pieces with Block Value therefore preserve that line in `description` rather than incorrectly mapping it to Block Chance.
