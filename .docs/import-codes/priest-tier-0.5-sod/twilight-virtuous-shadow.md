# Vestments of the Virtuous — Twilight

Season of Discovery Priest Dungeon Set 2 / Tier 0.5 Shadow DPS pieces.

Each block below is a standalone `RPE_DATASET_ENTRY_V1` import code for the Priest dataset (`cqblzgiw`).

All pieces are normalized to RPE item level **60** while retaining their Season of Discovery Vestments of the Virtuous stats.
