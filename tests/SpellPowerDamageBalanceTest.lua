...
local expected = {
    core = { 1.0 },
    mage = { 0.4016, 0.46, 0.5526, 0.612, 0.63, 0.6826, 0.845, 0.845, 0.884, 0.884, 0.8926, 1.04, 1.19, 1.2496, 1.2496, 1.9126, 2.6776, 2.8114, 3.5382 },
    paladin = { 0.338, 0.4, 0.845, 0.96, 1.105, 1.6 },
    priest = { 0.5028, 0.7, 0.833, 0.884, 1.04, 1.2496, 1.47, 1.82, 2.25 },
}
