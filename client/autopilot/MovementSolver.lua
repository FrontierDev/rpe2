        ...
        for sequenceIndex = 1, #(type(sequence) == "table" and sequence.actions or {}) do
            ...
            if type(unit) == "table" and type(candidate) == "table" then
                ...
                local action = {
                    ...
                    cooldownChannelId = entry.cooldownChannelId,
                    cooldownChannelName = entry.cooldownChannelName,
                    cooldownChannelTriggersGCD = entry.cooldownChannelTriggersGCD == true,
                    cooldownChannelCanUseOffTurn = entry.cooldownChannelCanUseOffTurn == true,
...
function Solver.CopyResult(state)
    ...
    for index = 1, #(result.actions or {}) do
        ...
        copiedActions[index] = {
            ...
            cooldownChannelId = source.cooldownChannelId,
            cooldownChannelName = source.cooldownChannelName,
            cooldownChannelTriggersGCD = source.cooldownChannelTriggersGCD == true,
