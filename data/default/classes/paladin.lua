    ...
    dataset = {
        ...
        items = {
            ...
            },
            {
                ...
                damagePerTurn = 0,
                description = "",
                icon = "interface/icons/inv_shoulder_10.blp",
                id = "s05hshld",
                isTwoHanded = false,
                itemLevel = 60,
                itemSetKey = "t05_pala_soulforge",
